...
const Sale = () => {
  ...
  const maxDiscount =
    saleProducts.length > 0 ? Math.max(...saleProducts.map(calcDiscount)) : 0;
    ...
    <div style={{ minHeight: "100vh", background: "#fafafa" }}>
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(135deg, #7f1d1d 0%, #b91c1c 40%, #c2410c 100%)",
      ...
      >
        ...
        >
          ...
          >
            Don't miss out on these incredible deals. Shop exceptional styles at
            unbeatable prices before they're gone.
          </p>
          {maxDiscount > 0 && (
            <div
              style={{
            ...
            >
              ...
              >
                Up to{" "}
                <span
                  style={{ color: "#fde68a", fontWeight: 900, fontSize: 22 }}
                >
                  {maxDiscount}% OFF
                </span>{" "}
                today
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          >
            <span style={{ fontSize: 14, color: "#6b7280", fontWeight: 500 }}>
              <strong style={{ color: "#111" }}>{saleProducts.length}</strong>{" "}
              sale products
            </span>
                  ...
                  >
                    ...
                    >
                      ...
                      {discount > 0 && (
                        ...
                        >
                          <Zap style={{ width: 12, height: 12 }} /> -{discount}%
                          OFF
                        </div>
                      )}
                      <button
              ...
              {[
                {
                  ...
                  a: "This mega sale is valid for a limited time only. Prices will return to normal after the promotion period concludes.",
                },
                {
                  q: "Are all items discounted?",
                  a: "Yes! Every item displayed in this section is marked down from its original retail price.",
                },
                {
                  q: "Can I return sale items?",
                  a: "Absolutely! All purchased sale items come with our standard 30-day return policy for peace of mind.",
                },
                {
                  q: "Is shipping free?",
                  a: "Yes! Enjoy complimentary free shipping on all orders over Rs. 5000, even during sale events.",
                },
              ].map((faq) => (
                <div
                  key={faq.q}
