...
const Bags = () => {
  ...
  // Filter Bags products within price range
  const bagsProducts = products
    .filter((p) => p.category === "Bags")
    .filter((p) => p.price >= priceRange[0] && p.price <= priceRange[1]);

  // Sort products based on selected option
  const sortedBagsProducts = [...bagsProducts].sort((a, b) => {
    switch (sortBy) {
      case "price-low":
      ...
      case "newest":
        ...
        // If one has createdAt and the other doesn't, put the one with createdAt first
        if (a.createdAt && !b.createdAt) return -1;
        if (!a.createdAt && b.createdAt) return 1;
        return 0; // Neither has createdAt
      default:
        return 0;
    }
  });
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">
                  {sortedBagsProducts.length} products
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedBagsProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <h3 className="font-semibold mb-2 text-lg group-hover:text-teal-700 transition-colors">
                        {product.name}
                      </h3>
