    ...
    <div style={{ minHeight: "100vh", background: "#fafafa" }}>
      ...
      <div
        style={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(135deg, #0a2018 0%, #0f3d2a 50%, #082016 100%)",
      ...
      >
        ...
        <div
          style={{
            ...
            height: 280,
            background:
              "radial-gradient(circle,rgba(52,211,153,.14) 0%,transparent 70%)",
            borderRadius: "50%",
            pointerEvents: "none",
          }}
        />
        ...
        >
          ...
          >
            Carry your essentials in style — blending function and modern
            aesthetics with expert craftsmanship.
          </p>
        </div>
      </div>
