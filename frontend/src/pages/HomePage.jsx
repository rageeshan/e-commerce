...
const HomePage = () => {
  ...
  const heroSlides = [
    {
      ...
      subtitle: "Elevate your everyday with curated styles crafted for the modern wardrobe.",
      image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=1600&h=900&q=90",
      cta: "Shop Now",
      href: "/clothes",
    },
    {
      ...
      subtitle: "Discover handpicked accessories that complete every look effortlessly.",
      image: "https://images.unsplash.com/photo-1479064555552-3ef4979f8908?auto=format&fit=crop&w=1600&h=900&q=90",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=1600&h=900&q=90",
      cta: "Discover More",
      href: "/shoes",
    },
  ];
  ...
  const features = [
    { icon: <Truck className="w-6 h-6" />, title: "Free Shipping", sub: "On orders above Rs. 5000" },
    { icon: <Shield className="w-6 h-6" />, title: "Secure Payment", sub: "100% secure transactions" },
    { icon: <RefreshCw className="w-6 h-6" />, title: "Easy Returns", sub: "30-day return policy" },
    { icon: <Sparkles className="w-6 h-6" />, title: "Premium Quality", sub: "Curated brands only" },
  ];
  ...
  const nextOffer = () => setCurrentOfferSlide((p) => (p === offers.length - 1 ? 0 : p + 1));
  const prevOffer = () => setCurrentOfferSlide((p) => (p === 0 ? offers.length - 1 : p - 1));

  const toggleWishlist = (id) =>
    setWishlist((p) => (p.includes(id) ? p.filter((x) => x !== id) : [...p, id]));

  const handleView = (id, e) => { e.stopPropagation(); navigate(`/product/${id}`); };
  const handleCart = (p, e) => { e.stopPropagation(); navigate(`/product/${p._id}`); };
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div style={{ textAlign: "center" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: 15, fontWeight: 500 }}>Loading StyleHub…</p>
        </div>
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafafa", fontFamily: "'Inter', sans-serif" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden" }}>
        <div style={{ position: "relative", height: "clamp(480px,80vh,700px)" }}>
          {heroSlides.map((slide, idx) => (
            ...
            >
              ...
              <div className="hp-hero-overlay" style={{ position: "absolute", inset: 0 }} />
              ...
              <div style={{
                ...
                {idx === currentSlide && (
                  <div style={{ maxWidth: 580 }}>
                    {/* Eyebrow */}
                    <div className="hp-fadein-up hp-d1" style={{
                    ...
                    {/* Title */}
                    <h1 className="hp-fadein-up hp-d2" style={{
                      fontSize: "clamp(2rem,5.5vw,3.75rem)",
                      fontWeight: 800, color: "#fff",
                      lineHeight: 1.12, marginBottom: 20,
                      whiteSpace: "pre-line", letterSpacing: "-.02em",
                    }}>
                      {slide.title}
                    </h1>

                    {/* Subtitle */}
                    <p className="hp-fadein-up hp-d3" style={{
                      fontSize: "clamp(14px,1.6vw,17px)",
                      color: "rgba(255,255,255,.82)", marginBottom: 36,
                    ...
                    {/* CTA */}
                    <div className="hp-fadein-up hp-d4" style={{ display: "flex", gap: 14 }}>
                      <button
                      ...
                      >
                        {slide.cta} <ArrowRight style={{ width: 16, height: 16 }} />
                      </button>
                      <button
          ...
          {[{ fn: prevSlide, side: "left", icon: <ChevronLeft /> }, { fn: nextSlide, side: "right", icon: <ChevronRight /> }].map(({ fn, side, icon }) => (
            <button key={side} onClick={fn} style={{
              ...
              zIndex: 10, background: "rgba(255,255,255,.15)", backdropFilter: "blur(10px)",
          ...
          <div style={{
            ...
            {heroSlides.map((_, i) => (
              <button key={i} onClick={() => setCurrentSlide(i)} style={{
                height: 6, width: i === currentSlide ? 32 : 8,
                borderRadius: 999, border: "none", cursor: "pointer",
                background: i === currentSlide ? "#fff" : "rgba(255,255,255,.4)",
      ...
      {/* ════════════ FEATURES BAR ════════════ */}
      <section style={{ background: "#fff", borderBottom: "1px solid #f1f1f1" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
          <div style={{
            ...
            {features.map((f, i) => (
              <div key={i} className="hp-feature" style={{
                display: "flex", alignItems: "center", gap: 16,
                padding: "28px 24px",
                borderRight: i < features.length - 1 ? "1px solid #f1f1f1" : "none",
                cursor: "default",
              }}>
                <div className="hp-feature-icon" style={{
                ...
                <div>
                  <p style={{ fontWeight: 700, fontSize: 14, color: "#111", marginBottom: 2 }}>{f.title}</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 48 }}>
            <div>
              ...
              <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)", fontWeight: 800, color: "#111", letterSpacing: "-.02em" }}>
                Featured Products
              </h2>
              <p style={{ color: "#6b7280", marginTop: 6, fontSize: 15 }}>Handpicked, freshly added to the store</p>
            </div>
            <button
          ...
          <div style={{
            ...
            {products.length > 0 ? products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ position: "relative", aspectRatio: "1/1", overflow: "hidden", background: "#f8f8f8" }}>
                    ...
                    <div style={{ position: "absolute", top: 12, left: 12, display: "flex", flexDirection: "column", gap: 6, zIndex: 10 }}>
                      <span style={{
                        ...
                        letterSpacing: ".06em", boxShadow: "0 2px 8px rgba(16,185,129,.4)",
                      }}>NEW</span>
                      {product.onSale && (
                        <span style={{
                          ...
                          color: "#fff", fontSize: 11, fontWeight: 700,
                          padding: "4px 10px", borderRadius: 999,
                          letterSpacing: ".06em", boxShadow: "0 2px 8px rgba(239,68,68,.4)",
                        }}>SALE</span>
                      )}
                    </div>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer", boxShadow: "0 2px 10px rgba(0,0,0,.12)",
                    ...
                    <div className="hp-card-actions" style={{
                      ...
                      <button
                        ...
                        style={{
                          ...
                          cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,.12)",
                        }}
                      >
                      ...
                      <button
                        ...
                        style={{
                          ...
                          padding: "10px 0", fontWeight: 600, fontSize: 13,
                          display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                          cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,.22)",
                        }}
                      >
                  ...
                  <div style={{ padding: "18px 20px 20px" }}>
                    ...
                    <p style={{ fontSize: 13, color: "#9ca3af", lineHeight: 1.6, marginBottom: 14, minHeight: 40, overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>
                      {product.description}
                    </p>
              ...
              <div style={{ gridColumn: "1/-1", textAlign: "center", padding: "64px 24px" }}>
                <p style={{ color: "#9ca3af", fontSize: 16 }}>No products available yet.</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section style={{ padding: "0 24px 80px", background: "#fafafa" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 20 }}>
            {[
              { label: "Clothes", href: "/clothes", img: "https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=700&h=400&q=80", accent: "#6366f1" },
              { label: "Shoes",   href: "/shoes",   img: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=700&h=400&q=80", accent: "#f43f5e" },
              { label: "Bags",    href: "/bags",    img: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=700&h=400&q=80", accent: "#f59e0b" },
            ].map((cat) => (
              <div
                key={cat.label}
                onClick={() => navigate(cat.href)}
                style={{
                  position: "relative", height: 220, borderRadius: 20, overflow: "hidden",
                  cursor: "pointer",
              ...
              >
                ...
                <div style={{
                  ...
                  <span style={{ color: "#fff", fontWeight: 800, fontSize: 22, letterSpacing: "-.01em" }}>{cat.label}</span>
                  <div style={{
                    background: cat.accent, borderRadius: "50%",
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <p style={{ color: "#818cf8", fontSize: 13, fontWeight: 600, letterSpacing: ".1em", textTransform: "uppercase", marginBottom: 10 }}>
              ✦ Limited Time
            </p>
            <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)", fontWeight: 800, color: "#fff", letterSpacing: "-.02em" }}>
              Special Offers
            </h2>
          </div>
          ...
          <div style={{ position: "relative" }}>
            {offers.map((offer, idx) => (
              ...
              >
                <div style={{
                  background: offer.grad, borderRadius: 24,
                  ...
                  <div style={{ fontSize: 48, marginBottom: 12 }}>{offer.icon}</div>
                  <h3 style={{ fontSize: 32, fontWeight: 800, color: "#fff", marginBottom: 10, letterSpacing: "-.02em" }}>
                    {offer.title}
                  </h3>
                  <p style={{ color: "rgba(255,255,255,.9)", fontSize: 17, marginBottom: 28 }}>
                    {offer.description}
                  </p>
                  ...
                  <div style={{
                    ...
                    borderRadius: 14, padding: "14px 28px", marginBottom: 20,
                  }}>
                    <Tag style={{ width: 18, height: 18, color: "#fff" }} />
                    <span style={{ color: "#fff", fontFamily: "monospace", fontWeight: 800, fontSize: 18, letterSpacing: ".12em" }}>
                      {offer.code}
                    </span>
                  </div>

                  <p style={{ color: "rgba(255,255,255,.65)", fontSize: 13 }}>{offer.expiry}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 16, marginTop: 32 }}>
            <button onClick={prevOffer} style={{
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {offers.map((_, i) => (
                <button key={i} onClick={() => setCurrentOfferSlide(i)} style={{
                  height: 6, width: i === currentOfferSlide ? 28 : 8,
                  borderRadius: 999, border: "none", cursor: "pointer",
                  background: i === currentOfferSlide ? "#fff" : "rgba(255,255,255,.35)",
                  transition: "all .4s ease",
                }} />
              ))}
            </div>
      ...
      <section style={{ padding: "80px 24px", background: "#fff" }}>
        <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
          <div style={{
            ...
            fontSize: 13, fontWeight: 600, letterSpacing: ".04em", marginBottom: 20,
          }}>
            <Sparkles style={{ width: 14, height: 14 }} />
            Stay in the Loop
          </div>

          <h2 style={{ fontSize: "clamp(1.6rem,3vw,2.4rem)", fontWeight: 800, color: "#111", letterSpacing: "-.02em", marginBottom: 12 }}>
            Get Exclusive Deals
          </h2>
          ...
          <form
            ...
            style={{ display: "flex", gap: 12, maxWidth: 520, margin: "0 auto" }}
          >
            <input
              type="email"
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 24px rgba(99,102,241,.5)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "";
